...
public class YRelay : YFunction
{
	...
	#region SAW Additions

	/// <summary>Returns the ID/Name that should be used by SAW.  This is the logical name if set.  If empty it uses the friendly name - (which is serial plus an addendum)</summary>
	public string SAWName
	{
		get
		{
			string name = get_logicalName();
	...
	/// <summary>SAW wrapper for get_State and set_State </summary>
	public bool StateActive
	{
		get { return get_state() == STATE_B; }
		set { set_state(value ? STATE_B : STATE_A); }
	}
	...
	public static string GetStateName(int state)
	{
		switch (state)
		{
			case YRelay.STATE_A: return Strings.Item("Yocto_State_A");
			case YRelay.STATE_B: return Strings.Item("Yocto_State_B");
			default: return "Unknown state: " + state;
		}
	}

	/// <summary>SAW wrapper returning "on" or "off" for current state </summary>
	public string StateName
	{
		get { return GetStateName(get_state()); }
	}
